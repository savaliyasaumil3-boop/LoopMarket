          ...
          <div className="p-4 border-t border-slate-100 space-y-2 bg-white mt-auto shrink-0">
            {isAuthenticated ? (
              <button
                ...
                className="flex items-center justify-center gap-2 w-full px-3 py-2 text-xs font-semibold text-rose-600 hover:text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-200 rounded-md transition cursor-pointer"
