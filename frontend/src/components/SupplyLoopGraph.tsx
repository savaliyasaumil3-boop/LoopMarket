  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-5 border-b border-slate-100">
        ...
        <div className="flex items-center gap-2 self-start">
          <button 
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium border border-slate-200 rounded-md hover:bg-slate-50 transition"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-6">
        ...
        <div className="lg:col-span-8 bg-slate-950 text-white rounded-lg p-6 relative overflow-hidden border border-slate-800 min-h-[420px] flex flex-col justify-between">
          ...
          <div className="relative z-10 flex justify-between text-xs font-mono text-slate-400 pb-2 border-b border-slate-800">
          ...
          <div className="relative z-10 grid grid-cols-3 gap-6 items-center my-auto py-4">
              ...
              {suppliers.map((s, idx) => (
                ...
                >
                  ...
                  <div className="mt-2 flex items-center justify-between text-[11px] text-slate-300">
                    ...
                    <span className="text-emerald-400 font-mono">FLOW IN →</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="flex flex-col items-center">
              {centralHub && (
                <div
                  ...
                  className={`cursor-pointer p-4 rounded-xl border-2 transition-all w-full text-center relative ${
                ...
                >
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-2.5 py-0.5 bg-emerald-500 text-slate-950 text-[10px] font-bold uppercase rounded-full tracking-wider">
                    My Facility
                  </div>
                  <Building2 className="w-6 h-6 text-emerald-400 mx-auto mt-1 mb-2" />
                  <h4 className="text-sm font-bold text-white leading-tight">{centralHub.name}</h4>
                  <p className="text-[11px] text-slate-400 mt-1">{centralHub.city}</p>
            ...
            <div className="space-y-4">
              {buyers.map((b, idx) => (
                ...
                >
                  ...
                  <div className="mt-2 flex items-center justify-between text-[11px] text-slate-300">
                    ...
                    <span className="text-blue-400 font-mono">FLOW OUT →</span>
                  </div>
                </div>
              ))}
              ...
              {recyclers.map((r) => (
                ...
                >
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-[10px] font-mono px-1.5 py-0.5 bg-amber-950 text-amber-300 rounded border border-amber-800">
                  ...
                  <div className="mt-2 flex items-center justify-between text-[11px] text-slate-300">
                    <span>{r.current_price}</span>
                    <span className="text-amber-400 font-mono">↻ RECIRCULATE</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        {/* Node Inspection Panel (4 cols) - Directly satisfying handwritten requirement: "When user presses on Company 1: It shows Company name, product, current supply contract, product information, current price of material" */}
        <div className="lg:col-span-4 bg-slate-50 border border-slate-200 rounded-lg p-5 flex flex-col justify-between">
          {selectedNode ? (
            <div className="space-y-4">
              ...
              <div className="pt-3 border-t border-slate-200 space-y-2">
                ...
                <button 
                  ...
                  className="w-full py-2 bg-white border border-slate-200 text-slate-700 rounded text-xs font-semibold hover:bg-slate-100 transition"
                >
